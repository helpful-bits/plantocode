...
export function H1({ children, className, as = "h1", ...props }: TypographyProps) {
  const Component = as;
  return (
    <Component className={cn("scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl", className)} {...props}>
      {children}
    </Component>
  );
}
...
export function H2({ children, className, as = "h2", ...props }: TypographyProps) {
  const Component = as;
  return (
    <Component className={cn("scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight", className)} {...props}>
      {children}
    </Component>
  );
}
...
export function H3({ children, className, as = "h3", ...props }: TypographyProps) {
  const Component = as;
  return (
    <Component className={cn("scroll-m-20 text-2xl font-semibold tracking-tight", className)} {...props}>
      {children}
    </Component>
  );
}
...
export function H4({ children, className, as = "h4", ...props }: TypographyProps) {
  const Component = as;
  return (
    <Component className={cn("scroll-m-20 text-xl font-semibold tracking-tight", className)} {...props}>
      {children}
    </Component>
  );
}
...
export function Lead({ children, className, as = "p", ...props }: TypographyProps) {
  const Component = as;
  return (
    <Component className={cn("text-xl text-muted-foreground", className)} {...props}>
      {children}
    </Component>
  );
}
