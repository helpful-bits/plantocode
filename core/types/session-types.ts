...
export type BackgroundJob = {
    ...
    metadata?: {
        ...
        isStreaming?: boolean; // Whether the job is currently streaming
        streamProgress?: number; // Percentage of progress (0-100)
        lastStreamUpdateTime?: number; // Timestamp of the last streaming update
        responseLength?: number; // Current character count of streamed response
