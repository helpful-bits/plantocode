    ...
    <div className="flex flex-col gap-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className={cn("text-xs bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 px-2 py-0.5 rounded-sm", !effectiveIsEmpty && "invisible")}>
            Required
          </span>
        </div>
        <Button
      ...
      <div className={`relative ${effectiveIsEmpty ? 'border-2 border-red-200 dark:border-red-800 rounded-md' : ''}`}>
        ...
        <div className={cn("text-xs text-red-600 dark:text-red-400 mt-1 pl-1", !effectiveIsEmpty && "invisible")}>
