...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::disk_commands::get_disk_space_command,
            commands::ffmpeg_commands::check_ffmpeg_available_command,
            commands::ffmpeg_commands::remux_video_command,
            ...
            commands::file_system_commands::append_binary_file_command,
            commands::file_system_commands::read_binary_file_command,
            commands::file_system_commands::get_file_stats_command,
            ...
            commands::implementation_plan_commands::generate_plan_markdown_command,
