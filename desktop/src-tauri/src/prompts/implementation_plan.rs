...
/// Legacy prompt template for generating implementation plans
/// This is kept for backward compatibility
pub fn generate_implementation_plan_prompt(task_description: &str, codebase_structure: Option<&str>) -> String {
    let mut prompt = format!(
r#"<implementation_plan>
    <agent_instructions>
        Read the following plan CAREFULLY, COMPREHEND IT, and IMPLEMENT it COMPLETELY. THINK HARD!
