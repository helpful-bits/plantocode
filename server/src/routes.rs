...
pub fn configure_routes(cfg: &mut web::ServiceConfig, strict_rate_limiter: RateLimitMiddleware) {
    cfg.service(
        web::scope("/auth") // Base path: /api/auth
            .route(
                "/userinfo",
                web::get().to(handlers::auth::userinfo_handler::get_user_info),
            )
            .route(
                "/logout",
    ...
    cfg.service(
        web::scope("/auth0") // Base path: /api/auth0 (protected)
            .route(
                "/refresh-app-token",
                web::post().to(handlers::auth0_handlers::refresh_app_token_auth0),
            ),
    );
    ...
    cfg.service(
        web::scope("/config")
            .route(
                "/all-configurations",
                web::get()
                    .to(handlers::config_handlers::get_all_application_configurations_handler),
            )
            .route(
                "/billing",
                web::get().to(handlers::config_handlers::get_billing_config),
            )
            .route(
                "/billing",
                web::put().to(handlers::config_handlers::update_billing_config),
            )
            .route(
                "/desktop-runtime-config",
                web::get().to(handlers::config_handlers::get_desktop_runtime_ai_config),
            ),
    );
    ...
    cfg.service(
        web::scope("/providers")
            .route(
                "",
                web::get().to(handlers::provider_handlers::get_all_providers),
            )
            .route(
                "/with-counts",
                web::get().to(handlers::provider_handlers::get_providers_with_counts),
            )
            .route(
                "/by-code/{code}",
                web::get().to(handlers::provider_handlers::get_provider_by_code),
            )
            .route(
                "/by-capability/{capability}",
                web::get().to(handlers::provider_handlers::get_providers_by_capability),
            ),
    );
    ...
    cfg.service(
        web::scope("/models")
            ...
            .route(
                "/{id}",
                web::get().to(handlers::model_handlers::get_model_by_id),
            )
            .route(
                "/by-provider/{provider_code}",
                web::get().to(handlers::model_handlers::get_models_by_provider),
            )
            .route(
                "/by-type/{model_type}",
                web::get().to(handlers::model_handlers::get_models_by_type),
            )
            .route(
                "/estimate-cost",
                web::post().to(handlers::model_handlers::estimate_cost),
            )
            .route(
                "/estimate-batch-cost",
                web::post().to(handlers::model_handlers::estimate_batch_cost),
            )
            .route(
                "/estimate-tokens",
                web::post().to(handlers::model_handlers::estimate_tokens_handler),
            ),
    );
    ...
    cfg.service(
        web::scope("/llm")
            .route(
                "/chat/completions",
                web::post().to(handlers::proxy_handlers::llm_chat_completion_handler),
            )
            .route(
                "/cancel",
                web::post().to(handlers::cancellation_handlers::cancel_request_handler),
            )
            .route(
                "/status/{request_id}",
                web::get().to(handlers::cancellation_handlers::get_request_status_handler),
            )
            .route(
                "/video/analyze",
    ...
    cfg.service(
        web::scope("/system-prompts")
            .route(
                "/defaults",
                web::get().to(handlers::system_prompts_handlers::get_default_system_prompts),
            )
            .route(
                "/defaults/{task_type}",
                web::get()
                    .to(handlers::system_prompts_handlers::get_default_system_prompt_by_task_type),
            ),
    );
    ...
    cfg.service(
        web::scope("/consent")
            .route(
                "/documents/current",
                web::get().to(handlers::consent_handlers::get_current_legal_documents),
            )
            .route(
                "/status",
                web::get().to(handlers::consent_handlers::get_consent_status),
            )
            .route(
                "/verify",
                web::get().to(handlers::consent_handlers::verify_consent),
            )
            .route(
                "/accept",
    ...
    cfg.service(
        web::scope("/devices")
            ...
            .route(
                "",
                web::get().to(handlers::device_handlers::get_devices_handler),
            )
            .route(
                "/{device_id}",
                web::delete().to(handlers::device_handlers::unregister_device_handler),
            )
            .route(
                "/{device_id}/heartbeat",
                web::post().to(handlers::device_handlers::heartbeat_handler),
            )
            .route(
                "/{device_id}/connection-descriptor",
                web::get().to(handlers::device_handlers::get_connection_descriptor_handler),
            )
            .route(
    ...
    cfg.service(
        web::scope("/notifications")
            .route(
                "/job-completed",
                web::post().to(handlers::notification_handlers::job_completed_handler),
            )
            .route(
                "/job-failed",
                web::post().to(handlers::notification_handlers::job_failed_handler),
            )
            .route(
                "/job-progress",
                web::post().to(handlers::notification_handlers::job_progress_handler),
            )
            .route(
                "/test",
                web::post().to(handlers::notification_handlers::test_notification_handler),
            ),
    );
}
...
pub fn configure_public_auth_routes(
    cfg: &mut web::ServiceConfig,
    account_creation_rate_limiter: RateLimitMiddleware,
) {
    cfg.service(
        web::scope("/auth0") // Base path: /auth/auth0
            .route(
                "/initiate-login",
                web::get()
                    .to(handlers::auth0_handlers::initiate_auth0_login)
                    .wrap(account_creation_rate_limiter),
            )
            .route(
                "/callback",
                web::get().to(handlers::auth0_handlers::handle_auth0_callback),
            )
...
async fn auth0_logged_out_handler(
    ...
    let redirect_url = format!("{}/auth/auth0/logged-out", settings.website_base_url);
