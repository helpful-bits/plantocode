...
('openai/o3-deep-research-2025-06-26', 'GPT-o3 Deep Research', 200000, '{"input_per_million": 2.00, "output_per_million": 8.00, "cached_input_per_million": 0.50}'::jsonb, (SELECT id FROM providers WHERE code = 'openai'), 'text', '{"text": true, "chat": true, "reasoning": true, "code": true, "vision": true, "agentic": true, "web_search": true, "code_exec": true}'::jsonb, 'active', 'Advanced OpenAI o3 model with deep research capabilities', 'o3-deep-research-2025-06-26'),
('openai/o4-mini-deep-research-2025-06-26', 'GPT-o4 Mini Deep Research', 200000, '{"input_per_million": 1.10, "output_per_million": 4.40, "cached_input_per_million": 0.275}'::jsonb, (SELECT id FROM providers WHERE code = 'openai'), 'text', '{"text": true, "chat": true, "reasoning": true, "code": true, "vision": true, "agentic": true, "web_search": true, "code_exec": true}'::jsonb, 'active', 'Efficient OpenAI o4 model with deep research capabilities', 'o4-mini-deep-research-2025-06-26'),
...
-- OpenRouter models (prices per 1M tokens) - DeepSeek models via OpenRouter
('deepseek/deepseek-r1-0528', 'DeepSeek R1 (0528)', 131072, '{"input_per_million": 0.55, "output_per_million": 2.19}'::jsonb, (SELECT id FROM providers WHERE code = 'openrouter'), 'chat', '{"chat": true, "reasoning_content": true, "json_output": true, "function_calling": true, "chat_prefix_completion": true}'::jsonb, 'active', 'DeepSeek R1 0528 - Premium reasoning model (paid only)', 'deepseek-r1-0528'),
