...
### Server Targets
- **US Server**: `interserver-us` (YOUR_US_SERVER_IP)
- **EU Server**: `hetzner-primary` (YOUR_EU_SERVER_IP)
- **All servers**: `all`
...
ssh root@YOUR_US_SERVER_IP -i ~/.ssh/id_ed25519_interserver "<command>"
ssh root@YOUR_EU_SERVER_IP -i ~/.ssh/id_ed25519_hetzner "<command>"
```
