-- Migration to remove pattern_description column from sessions table

PRAGMA foreign_keys=off; -- Disable foreign key constraints temporarily

-- Step 1: Create a new sessions table without the pattern_description column
...
-- Step 2: Copy data from the old table to the new table, excluding pattern_description
