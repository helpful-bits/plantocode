...
export default function VoiceTranscription({
  ...
  const handleRevertToRaw = useCallback(() => {
    ...
    console.log("[VoiceTranscription] Handling revert to raw text, length:", rawText.length);
    ...
    if (textareaRef?.current) {
      try {
        ...
        // Provide feedback that raw text was inserted
        toast({
        ...
        try {
          ...
          // Provide feedback about the fallback
          toast({
            title: "Insertion Fallback",
            description: "Couldn't insert at cursor position. Raw text has been added at the end instead.",
            variant: "warning"
          });
          ...
          toast({
            title: "Revert Failed",
            description: "Could not revert to raw text. Please try again or type manually.",
            variant: "destructive"
          });
        }
      }
    ...
    <div className="flex flex-col gap-2 border rounded-lg p-4 bg-card shadow-sm">
      ...
      <div className="flex gap-3 items-start">
        <div className="flex flex-col">
          ...
          <p className="text-xs text-muted-foreground mt-1 text-balance">Record your task description using your microphone. Groq transcribes and Claude automatically improves the text.</p>
        </div>
        <div className="flex flex-col">
          <div className="h-9">
          ...
          <p className="text-xs text-muted-foreground mt-1 text-balance">Select the language you will be speaking.</p>
        </div>
      </div>
