...
export default function Home() {
  const softwareApplicationJsonLd: SoftwareApplication = {
    ...
    screenshot: 'https://d2tyb0wucqqf48.cloudfront.net/og-image.png',
    featureList: [
  ...
  const steps = [
    {
      ...
      video: 'https://d2tyb0wucqqf48.cloudfront.net/step-1-describe.mp4',
      poster: 'https://d2tyb0wucqqf48.cloudfront.net/step-1-poster.jpg',
    },
    {
      ...
      video: 'https://d2tyb0wucqqf48.cloudfront.net/step-2-find.mp4',
      poster: 'https://d2tyb0wucqqf48.cloudfront.net/step-2-poster.jpg',
    },
    {
      ...
      video: 'https://d2tyb0wucqqf48.cloudfront.net/step-3-generate.mp4',
      poster: 'https://d2tyb0wucqqf48.cloudfront.net/step-3-poster.jpg',
    },
    {
      ...
      video: 'https://d2tyb0wucqqf48.cloudfront.net/step-4-merge.mp4',
      poster: 'https://d2tyb0wucqqf48.cloudfront.net/step-4-poster.jpg',
    },
  ];
