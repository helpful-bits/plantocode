              ...
              <div className="grid gap-8 md:gap-12">
                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
                      <LinkWithArrow href="/architecture" className="font-semibold">{t['downloads.cta.architect']}</LinkWithArrow>
                      <span className="hidden sm:inline text-foreground/40">•</span>
                      <LinkWithArrow href="/docs/implementation-plans" className="font-semibold">{t['downloads.cta.professional']}</LinkWithArrow>
                      <span className="hidden sm:inline text-foreground/40">•</span>
