...
export default function WhatIsAICodePlanningPage() {
  return (
    <BlogArticle
      title="What is AI Code Planning? A Developer's Guide"
      description="AI coding assistants can write code faster than ever. But the faster they move, the more chaos they create. AI code planning adds a safety layer: think first, code second."
      date="2025-11-01"
      readTime="12 min"
      category="Concepts"
          ...
          <ol className="space-y-4 my-8">
            <li>
              ...
              <p className="text-foreground/80">
                Tools like <Link href="/" className="text-primary hover:underline">PlanToCode</Link> specialize in generating
