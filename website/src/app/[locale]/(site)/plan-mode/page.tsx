            ...
            <div className="container mx-auto max-w-6xl">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-base sm:text-lg text-foreground/80 mb-8">
                  ...
                  {t['planMode.hero.guidance'] || 'Voice → Text Improvement → Task Refinement → File Discovery (Root selection, Regex, AI Relevance, Extended Pathfinder) → Generate multiple plans (GPT-5.2, Claude Sonnet 4.5, Gemini 3 Pro) → Merge → Execute in agents (Aider, Cursor, Claude Code, Codex)'}
                </p>
