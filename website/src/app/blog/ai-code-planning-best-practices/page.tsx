      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        <article className="prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-xl text-foreground/80 mb-8">
            AI can generate implementation plans in seconds. But a bad plan executed perfectly is still a disaster.
            Here are the proven best practices for AI code planning in production environments.
          </p>
