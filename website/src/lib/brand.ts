...
export const BRAND_X_HANDLE = process.env.NEXT_PUBLIC_X_HANDLE || 'helpfulbits_com';
export const FEATUREBASE_ORG = process.env.NEXT_PUBLIC_FEATUREBASE_ORG || 'plantocode';
