...
import { Play, CheckCircle2, Target, Mic, Sparkles, FileSearch, Layers, Files, Settings, FileCheck } from 'lucide-react';
    ...
    <section className="relative flex flex-col items-center bg-transparent w-full">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-10 sm:pb-14 w-full">
        ...
        >
          ...
          <br />
          {t('hero.titleLine2', 'With Architect-Level Precision')}
        </h2>
      ...
      <div className="relative w-full px-4 sm:px-6 lg:px-4 xl:px-8">
        <div className="w-full mx-auto relative">
          ...
          {/* CTAs and Testimonial */}
          <div className="flex flex-col items-center gap-6 pb-12 px-4 max-w-5xl mx-auto">
            ...
            >
              <div className="relative p-8 rounded-2xl bg-background/50 border border-border/50 backdrop-blur-sm">
                <p className="text-base sm:text-lg text-foreground/80 italic mb-6">
                  {t('hero.testimonial.quote', "I built PlanToCode because accurate planning is mission-critical - I needed to know exactly what context and system prompts are being used. I use it every day for almost every feature I build. Now I can run multiple AI models in parallel, compare their architectural approaches, and merge the best ideas. It's like having multiple AI architects that you fully control.")}
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-full overflow-hidden">
                    <Image
                      src={cdnUrl('/images/founder-kiryl.jpg')}
                      alt={t('hero.testimonial.name', 'Kiryl Kazlovich')}
                      width={64}
                      height={64}
                  ...
                  <div className="text-left">
                    <div className="font-semibold text-foreground">
                      {t('hero.testimonial.name', 'Kiryl Kazlovich')}
                    </div>
                    <div className="text-sm text-foreground/60">
                      {t('hero.testimonial.title', 'Creator of PlanToCode')}
                    </div>
                  </div>
                </div>
              </div>
