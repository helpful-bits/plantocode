...
// Import monaco workers to initialize
...
const MonacoCodeViewer = forwardRef<HTMLDivElement, MonacoCodeViewerProps>(
  ({
    content,
    language,
    className,
    ...
    // Initialize with proper dark mode detection
    ...
    // Detect dark mode from website's actual theme state
    useEffect(() => {
    ...
    useEffect(() => {
      console.log('MonacoCodeViewer theme:', { isDarkMode, editorTheme });
...
MonacoCodeViewer.displayName = "MonacoCodeViewer";
